...
#define MARIO_RACCOON_FLAPPING_SPEED 0.02f //0.002
#define MARIO_RACCOON_FALL_SLOW_SPEED 0.04f  //0.025
...
//time
#define LIMIT_MARIO_RACCOON_FLY_TIME 6000
...
#define MARIO_DIE_TIME_OUT_WM 3000
