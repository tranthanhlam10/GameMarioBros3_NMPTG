...
CSprite::CSprite(int id, int left, int top, int right, int bottom, LPTEXTURE tex) // khởi tạo sprite lên màn hình
{
	this->id = id;
	this->left = left;
	this->top = top;
...
void CSprite::Draw(float x, float y) // vẽ sprite lên chương trình
{
