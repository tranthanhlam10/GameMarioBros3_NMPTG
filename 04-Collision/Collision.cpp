...
*/
	...
	// sử lí va cham với 2 object đang chuyển động
...
// tính toán xem nên sử lí va chạm với oject nào trước trong tất cả trường hợp có va chạm xảy ra
...
void CCollision::Process(LPGAMEOBJECT objSrc, DWORD dt, vector<LPGAMEOBJECT>* coObjects) // hàm sử lí va chạm
{
	vector<LPCOLLISIONEVENT> coEvents;
